...
그리고 나는 자극을 먹고사는 개발자이기도 하다. 동기의 이직은 굉장히 큰 자극으로..

### '왜'를 생각하는 자세?

나에게 많은 롤들이 생기면서 어깨가 무거워졌었다. 이때 당시 본부장님, 팀장님은 나를 믿고 많은 `배려` 를 해주셨다. 내 의견을 적극 반영해주셨고, 시간적인 배려도 아끼지 않으셨다. 너무 감사한 분들이다.

이런 적극적인 지원 속에서 좋은 방향으로 나가기 위해 **항상** '이렇게 하는게 좋다더라', '다른데서 이렇게 하고 있더라' **보다는** '이렇게 하는게 어떠한 이유때문에 좋다, 아니다', '다른데서 이렇게 하고 있는데, 이러한 환경에서 이러한 방향으로 진행했기 때문에 좋았다' 를 중요시하며 개발을 하였다. 불안함 속에서 습관이 자리잡은 것 같다.
...
팀장님은 내 2년차를 돌아보며 빼놓을 수 없는 분이다.

내가 목말라 있었던 경험을 토대로한 `Real World`를 정말 많이 알려주셨다. 실무에는 다양한 사례들이 있고, 다양한 상황이 있다. 팀장님은 아마 내가 가지고 있던 고정관념을 가장 많이 깨주신 분일 듯 하다.

거기에 우리가 목말라 있던 것들에 대해 직접 지인들을 초빙하여 회사 세미나까지 열어주셨고, 숙제와 같이 우리에게 부족한 것들을 부담없이 던져주시며 스스로 성장할 수 있게 기회를 많이 주셨다.

오래 함께하진 못했어도 정말 많이 배울 수 있었다. (빙산의 일각이라고 하셨다)

### Spring Camp

작년 한 해 동안 수많은 세미나를 돌아다녔었다. 그리고 2년차가 되서는, 나도 어느 조그마한 세미나에서라도 발표를 해보자고 결심했다. 그런데 정말 운이 좋게도(?) 너무 큰 세미나에서 발표 기회를 가지고 되었다. 바로 `Spring Camp 2017` 이다.
...
**(다시한번 정말 많은 도움과 기회를 주신 `운영진`분들께 감사드립니다.)**
...
이직을 위한 `준비`는 이 이외에는 하지 않았다. 개인적으로 내가 하는 개발에 큰 도움되지 않는 고수준의 알고리즘 공부를 좋아하지 않는다. 알고리즘을 따로 공부하지 않았지만, 개발과 알고리즘의 밀접한 관계는 땔래야 땔 수 없기 떄문에 그 속에서 나름의 방법으로 알고리즘을 학습해왔다고 생각했다. 그래서 시험을 위한 알고리즘 공부도 하지 않았다.

그저 그동안의 내가 한 개발을 평가받고 싶었다!

### 부족했던 것

-	과정에 있는 어떠한 툴이라도 사용법에 대해서 그냥 넘기지 말자! 알고리즘 사이트 툴이 다 거기서 거기지 하는 마음으로 했다가 절반의 시간이 지나서야 잘못된 것을 알아차리고 망한 곳이 있음.
